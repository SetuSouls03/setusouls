  ...
  return (
    <div className="policy-wrapper">
      <div className="policy-container">
        ...
        <h2 style={{marginBottom:'1.5rem'}}>8. Contact Us</h2>
        <p><a href='https://mail.google.com/mail/?view=cm&fs=1&to=setusouls@gmail.com' style={{color:'black'}}>Email: setusouls@gmail.com</a></p>
      </div>
    </div>
  );
};
