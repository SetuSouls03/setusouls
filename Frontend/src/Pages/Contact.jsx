      ...
      <div className="contact-container">
        <div className="contact-header">
          ...
          <p className="contact-intro">
            We'd love to hear from you. Reach out for questions, insights, or spiritual discussions.
          </p>
        </div>
        ...
        <div className="contact-grid">
          ...
          <div className="contact-card">
            ...
            <p className="contact-text">For direct inquiries and personal communication</p>
            <a
          ...
          <div className="contact-card">
            <div className="contact-icon social">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <path
                  fillRule="evenodd"
                  d="M5 5a3 3 0 00-3 3v8a3 3 0 003 3h8a3 3 0 003-3v-3a1 1 0 10-2 0v3a1 1 0 01-1 1H5a1 1 0 01-1-1V8a1 1 0 011-1h3a1 1 0 000-2H5z"
                  clipRule="evenodd"
                />
              </svg>
            </div>
            <h2 className="contact-subheading">Social Media</h2>
            <p className="contact-text">Connect with us on various platforms for updates and wisdom</p>
            ...
            <div className="social-links">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=100002227446422"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://theimmortaltalks.quora.com/?ch=10&oid=2188707&share=396067ef&srid=iGMyh&target_type=tribe"
                target="_blank"
                rel="noopener noreferrer"
                className="social-button quora"
                aria-label="Quora"
              >
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
